...
public class Main extends Application {
    ...
    public void initialize() {
        ...
        Shape r4 = new Rectangle(new CanvasPosition(200,60), 0, new Position(0,0), new Position(0,0), "#a823b3", 300, 320, 0, implementor);

        Shape p = new Polygon(new CanvasPosition(150,300), -18, new Position(0,0), new Position(0,0), "#4472c4", 5, 100, implementor);
